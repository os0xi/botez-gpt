...
export default async function handler(
  ...
  const midJourney = await chain.call({
    input:
      "the same Human speaks: Take your first answer and turn it into a retro-sci-fi painting. Reply in English with purely the description of this painting, without explaining what you did or what it is. Thank you! <3",
  });
